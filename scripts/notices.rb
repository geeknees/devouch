# ABOUTME: Collects license texts for installed production dependency packages and ENS artifacts.
...
puts "Included licenses for #{visited.length} production packages and ENSv2."
